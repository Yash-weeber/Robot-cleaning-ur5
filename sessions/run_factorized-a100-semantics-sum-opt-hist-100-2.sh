...
#SBATCH --array=1-3                   # Array range: tasks 1 to 3
#SBATCH -o sessions/errors/template-sum-opt.%j.out
#SBATCH -e sessions/errors/template-sum-opt.%j.err
...
# --- Run your program ---
python main_llm_sum_opt.py --config semantics-hist-100-sum-opt-2.yaml