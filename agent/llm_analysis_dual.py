...
def build_llm_feedback(iter_idx, w_df, iter_log_data, traj_feedback_data, ee_traj_df, config, bounds,critic_advice=None):
    ...
    feedback_text = ""
    if critic_advice:
        # We inject the advice at the very top of the feedback string
        separator_advice =  " CRITIC GUIDANCE FOR THIS ITERATION " 
        feedback_text += f"{separator_advice}\n{critic_advice}\n"
